      ...
      <div className="flex justify-around">
        ...
        <div className={less.vipItem}>
          ...
          <div className="text-left">
            ...
            <div className="text-gray-600">
              ...
              <div className="pl-5 mb-2">✅ 5 次查询每天</div>
              <div className="mb-2">
                <span className="text-xs text-gray-300 mr-[10px]">●</span>
                <span>访问所有基础功能</span>
              </div>
              ...
              <div className="mb-2">
                <span className="text-xs text-gray-300 mr-[10px]">●</span>
                <span>
                  支持网页版本、Chrome/Edge浏览器插件版本 <span className="text-[#aaaaaa]">（即将）</span>{' '}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className={less.vipItem + ' ' + less.active}>
          ...
          <div className="text-[30px] font-bold mb-2">
            {priceList[timeType].pro.month}元 <span className="text-[24px]">/月</span>
          </div>
        ...
        <div className={less.vipItem}>
          <div className="text-[20px] font-bold mb-4 text-[#1A8BFE]">ZHIKE Pro+</div>
          <div className="text-[30px] font-bold mb-2">
            {priceList[timeType].pro_plus.month}元 <span className="text-[24px]">/月</span>
          </div>
