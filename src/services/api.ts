...
// 获取微信登录二维码
export async function getWeChatQRCode(options?: { [key: string]: any }) {
...
// 关闭当前 chat
export async function closeChat(id: string, options?: { [key: string]: any }) {
...
// 删除自定义模版
export async function delCustomTemplate(id, options?: { [key: string]: any }) {
...
// 用户 订单列表
export async function bookingList(options?: { [key: string]: any }) {
  return request('/v1/user/personal/booking/list', {
    method: 'GET',
    ...(options || {}),
  })
}
...
// 用户中心数据
export async function userVipData(options?: { [key: string]: any }) {
  return request('/v1/user/personal/info', {
    method: 'GET',
    ...(options || {}),
  })
}
